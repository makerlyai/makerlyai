        ...
        case "mention":
          return (
            <a
              ...
              className="text-[#1C9BF1] hover:underline whitespace-pre-wrap"
            >
              {entity.text}
            </a>
          );
...
const TweetContent = ({
  ...
  return (
    <div
      className={cn(
        "w-full max-w-[590px] rounded-2xl p-6 bg-black/40 backdrop-blur-xl border border-white/10 shadow-[0_8px_30px_rgb(0,0,0,0.12)]",
        className
      )}
    >
...
export function Tweet({
  ...
  const tweet = {
    id_str: id,
    text: "Building the absolute best digital architecture for our clients.\n\nFrom blazing fast Software as a Service to intelligent AI Agents. We don't just write code—we engineer empires. 🚀✨",
    created_at: "Wed Mar 12 10:30:00 +0000 2026",
    favorite_count: 5192,
    ...
    user: {
      id_str: "1",
      name: "MakerlyAI",
      profile_image_url_https: "/initialletterlogosquare.png",
      screen_name: "MakerlyAI",
      verified: false,
